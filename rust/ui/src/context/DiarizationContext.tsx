...
export const DiarizationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    useEffect(() => {
        ...
        // FluidAudio (coreml) не требует моделей диаризации и не зависит от активной модели транскрипции
        // Включаем сразу после подключения
    ...
    useEffect(() => {
        const unsubEnabled = subscribe('diarization_enabled', (msg: any) => {
        ...
        const unsubStatus = subscribe('diarization_status', (msg: any) => {
        ...
        const unsubError = subscribe('diarization_error', (msg: any) => {
