    ...
    return (
        <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', minWidth: 0 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', minWidth: 0 }}>
                        <span style={{ fontWeight: 'var(--font-weight-semibold)', fontSize: '0.95rem', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>
                            {model.name}
                        </span>
                        <HelpTooltip title={model.name} maxWidth={480}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', fontSize: '0.9rem' }}>
                                    <span style={{ color: 'rgba(255,255,255,0.8)' }}>Размер: {model.size}</span>
                                    <span style={{ color: 'rgba(255,255,255,0.8)' }}>Скорость: {model.speed}</span>
                                    {model.wer && <span style={{ color: 'rgba(255,255,255,0.8)' }}>WER: {model.wer}</span>}
                                    <span style={{ color: 'rgba(255,255,255,0.8)' }}>Тип: {model.type === 'ggml' ? 'Whisper (GGML)' : model.type === 'onnx' ? 'GigaAM (ONNX)' : 'Parakeet (CoreML)'}</span>
                                </div>
                                {model.type === 'coreml' && (
                                    <div style={{
                                        padding: '8px 10px',
            ...
            <div style={{ 
                ...
                <span>•</span>
                <span>{model.engine === 'whisper' ? 'Whisper' : model.engine === 'gigaam' ? 'GigaAM' : 'Parakeet'}</span>
