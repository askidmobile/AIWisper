...
const openDataFolder = async () => {
    try {
        ...
        if ('__TAURI__' in window) {
            ...
            // Use custom command to open data folder
            const result = await invoke('open_data_folder');
            console.log('[Sidebar] Opened data folder:', result);
            return;
        }
        ...
        console.error('[Sidebar] Failed to open data folder:', err);
        // Show error to user
        alert(`Не удалось открыть папку: ${err}`);
    }
};
