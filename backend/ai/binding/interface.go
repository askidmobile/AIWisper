...
type Context interface {
	...
	SetDiarize(bool)                  // Enable tinydiarize speaker turn detection (requires stereo input)
...
type Segment struct {
	...
	// SpeakerTurnNext indicates if the next segment is from a different speaker
	// (tinydiarize feature - requires stereo audio input)
